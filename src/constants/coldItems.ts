...
export const coldItems: MenuItem[] = [
  ...
  { id: 'ds-2',  name: 'تشيز كيك فلافور',        description: 'تشيز كيك بنكهة خاصة مميزة',               price: 80,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  { id: 'ds-3',  name: 'تشيز كيك نوتيلا',        description: 'تشيز كيك مع نوتيلا الكريمية',             price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/', badge: 'Popular' },
  { id: 'ds-4',  name: 'تشيز كيك لوتس',          description: 'تشيز كيك مع صوص لوتس الكراميلي',          price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  { id: 'ds-5',  name: 'تشيز كيك بستاشيو',       description: 'تشيز كيك مع فستق حلبي فاخر',              price: 90,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  { id: 'ds-6',  name: 'مولتن كيك كلاسيك',       description: 'كيك شوكولاتة ذائبة بمركز ساخن',           price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  ...
  { id: 'ds-8',  name: 'ديسباسيتو',              description: 'حلوى ديسباسيتو بكريمة الكاسترد',          price: 90,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  ...
  { id: 'ds-15', name: 'بان كيك 10 قطع',         description: 'عشر قطع بان كيك صغيرة طرية لذيذة',        price: 35,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  ...
  { id: 'ds-17', name: 'بان كيك 30 قطعه',        description: 'ثلاثون قطعة للحفلات والعائلات',            price: 80,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  { id: 'ds-18', name: 'طاجن نوتيلا',            description: 'طاجن نوتيلا ساخن كريمي لا يُقاوَم',       price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/' },
  ...
  { id: 'ds-20', name: 'طاجن سكاي مود',          description: 'طاجن sky 7 الأسطوري — فخامة في كل لقمة',  price: 130, currency: 'ج.م', category: 'desserts', image: '/images/sweets/', badge: 'New' },
