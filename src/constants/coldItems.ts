...
export const coldItems: MenuItem[] = [
  // ── سموزي ────────────────────────────────────────────────────────────────
  { id: 'sm-1',  name: 'سموزي ليمون',            description: 'سموزي ليمون منعش طبيعي',                  price: 50,  currency: 'ج.م', category: 'smoothies', image: SMO[2] },
  { id: 'sm-2',  name: 'سموزي ليمون نعناع',      description: 'سموزي ليمون ونعناع بارد ومنعش',           price: 60,  currency: 'ج.م', category: 'smoothies', image: SMO[2] },
  { id: 'sm-3',  name: 'سموزي مانجو',            description: 'سموزي مانجو استوائي حلو ومنعش',           price: 60,  currency: 'ج.م', category: 'smoothies', image: SMO[3] },
  { id: 'sm-4',  name: 'سموزي فراوله',           description: 'سموزي فراولة وردي لا يُقاوَم',            price: 60,  currency: 'ج.م', category: 'smoothies', image: SMO[0], badge: 'Popular' },
  { id: 'sm-5',  name: 'سموزي جوافه',            description: 'سموزي جوافة استوائي بنكهة أصيلة',          price: 60,  currency: 'ج.م', category: 'smoothies', image: SMO[3] },
  { id: 'sm-6',  name: 'سموزي بطيخ',            description: 'سموزي بطيخ منعش بلون أحمر جميل',          price: 65,  currency: 'ج.م', category: 'smoothies', image: SMO[3] },
  { id: 'sm-7',  name: 'سموزي بطيخ نعناع',      description: 'بطيخ ونعناع في سموزي صيفي مثالي',         price: 70,  currency: 'ج.م', category: 'smoothies', image: SMO[2] },
  { id: 'sm-8',  name: 'سموزي بلو بيري',         description: 'سموزي توت أزرق غني بالأنتيوكسيدان',       price: 70,  currency: 'ج.م', category: 'smoothies', image: SMO[0] },
  { id: 'sm-9',  name: 'سموزي ميكس بيري',        description: 'خليط التوت المتنوع في سموزي صحي',          price: 70,  currency: 'ج.م', category: 'smoothies', image: SMO[0] },
  { id: 'sm-10', name: 'سموزي باشن فروت',        description: 'سموزي باشن فروت استوائي فريد',             price: 70,  currency: 'ج.م', category: 'smoothies', image: SMO[3] },
  { id: 'sm-11', name: 'سموزي خوخ',              description: 'سموزي خوخ طازج بنكهة حلوة',               price: 70,  currency: 'ج.م', category: 'smoothies', image: SMO[3] },
  { id: 'sm-12', name: 'سموزي اناناس',           description: 'سموزي اناناس استوائي منعش',               price: 70,  currency: 'ج.م', category: 'smoothies', image: SMO[3] },
  { id: 'sm-13', name: 'سموزي كيوي',             description: 'سموزي كيوي أخضر بنكهة استوائية',          price: 85,  currency: 'ج.م', category: 'smoothies', image: SMO[2] },
  { id: 'sm-14', name: 'سموزي ميكس سكاي',        description: 'سموزي sky 7 المميز — خلطة سرية فاخرة',    price: 90,  currency: 'ج.م', category: 'smoothies', image: SMO[3], badge: "Chef's Choice" },

  // ── مع الزبادي ───────────────────────────────────────────────────────────
  { id: 'yg-1',  name: 'زبادي خلاط',             description: 'زبادي طازج محلوط بنعومة كريمية',          price: 45,  currency: 'ج.م', category: 'yogurt', image: YOG[0] },
  { id: 'yg-2',  name: 'زبادي عسل',              description: 'زبادي كريمي مع عسل نحل طبيعي',            price: 50,  currency: 'ج.م', category: 'yogurt', image: YOG[0], badge: 'Popular' },
  { id: 'yg-3',  name: 'زبادي فلافور',           description: 'زبادي بنكهات متنوعة مميزة',                price: 60,  currency: 'ج.م', category: 'yogurt', image: YOG[1] },
  { id: 'yg-4',  name: 'زبادي فواكه',            description: 'زبادي كريمي مع فواكه طازجة',              price: 85,  currency: 'ج.م', category: 'yogurt', image: YOG[1] },
