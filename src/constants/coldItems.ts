...
export const coldItems: MenuItem[] = [
  ...
  { id: 'sm-7',  name: 'سموزي بطيخ نعناع',      description: 'بطيخ ونعناع في سموزي صيفي مثالي',         price: 70,  currency: 'ج.م', category: 'smoothies', image: '/images/smoothi/WhatsApp Image 2026-07-29 at 03.48.08.jpeg' },
  ...
  // ── الحلويات ──────────────────────────────────────────────────────────────
  { id: 'ds-1',  name: 'تشيز كيك كلاسيك',        description: 'تشيز كيك نيويورك بالجبن الكريمي',          price: 70,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53.jpeg'},
  { id: 'ds-2',  name: 'تشيز كيك فلافور',        description: 'تشيز كيك بنكهة خاصة مميزة',               price: 80,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_kneay2kneay2knea.jpg' },
  { id: 'ds-3',  name: 'تشيز كيك نوتيلا',        description: 'تشيز كيك مع نوتيلا الكريمية',             price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_2mxxlf2mxxlf2mxx.jpg', badge: 'Popular' },
  { id: 'ds-4',  name: 'تشيز كيك لوتس',          description: 'تشيز كيك مع صوص لوتس الكراميلي',          price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_mi9kdmi9kdmi9kdm.jpg' },
  { id: 'ds-5',  name: 'تشيز كيك بستاشيو',       description: 'تشيز كيك مع فستق حلبي فاخر',              price: 90,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_enzojsenzojsenzo.jpg' },
  { id: 'ds-6',  name: 'مولتن كيك كلاسيك',       description: 'كيك شوكولاتة ذائبة بمركز ساخن',           price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_m5mztmm5mztmm5mz.jpg' },
  { id: 'ds-7',  name: 'مولتن كيك نوتيلا ايس',   description: 'مولتن كيك مع نوتيلا وآيس كريم فانيليا',  price: 100, currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (1).jpeg', badge: "Chef's Choice" },
  { id: 'ds-8',  name: 'ديسباسيتو',              description: 'حلوى ديسباسيتو بكريمة الكاسترد',          price: 90,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_q82k50q82k50q82k.jpg' },
  { id: 'ds-9',  name: 'وافل نوتيلا',            description: 'وافل بلجيكي مع نوتيلا وكريمة شنطة',       price: 85,  currency: 'ج.م', category: 'desserts', image:'/images/sweets/Gemini_Generated_Image_aj7uhkaj7uhkaj7u.jpg'},
  { id: 'ds-10', name: 'وافل شوكلت',             description: 'وافل مُقرمَش مع شوكولاتة داكنة',           price: 85,  currency: 'ج.م', category: 'desserts', image:'/images/sweets/Gemini_Generated_Image_2mmaao2mmaao2mma.jpg' },
  { id: 'ds-11', name: 'وافل كراميل',            description: 'وافل ذهبي مع كراميل محضّر يدوياً',        price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_64qcmw64qcmw64qc.jpg', badge: 'Popular' },
  { id: 'ds-12', name: 'وافل بستاشيو',           description: 'وافل مع فستق حلبي فاخر ومميز',            price: 100, currency: 'ج.م', category: 'desserts', image: '/images/sweets/Gemini_Generated_Image_tfkso3tfkso3tfks.jpg' },
  { id: 'ds-13', name: 'وافل ميكس صوص',          description: 'وافل مع خليط من الصوصات الفاخرة',          price: 110, currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.54 (1).jpeg' },
  { id: 'ds-14', name: 'وافل سكاي مود',          description: 'وافل sky 7 الخاص — التجربة الكاملة',       price: 130, currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.54 (1).jpeg', badge: 'New' },
  { id: 'ds-15', name: 'بان كيك 10 قطع',         description: 'عشر قطع بان كيك صغيرة طرية لذيذة',        price: 35,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (3).jpeg' },
  { id: 'ds-16', name: 'بان كيك 20 قطعه',        description: 'عشرون قطعة بان كيك مع توبينجز متنوعة',    price: 60,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (3).jpeg', badge: 'Popular' },
  { id: 'ds-17', name: 'بان كيك 30 قطعه',        description: 'ثلاثون قطعة للحفلات والعائلات',            price: 80,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (3).jpeg' },
  { id: 'ds-18', name: 'طاجن نوتيلا',            description: 'طاجن نوتيلا ساخن كريمي لا يُقاوَم',       price: 85,  currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (2).jpeg' },
  { id: 'ds-19', name: 'طاجن هرمون السعادة',      description: 'طاجن بالشوكولاتة والكريمة والفواكه',       price: 100, currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (2).jpeg', badge: "Chef's Choice" },
  { id: 'ds-20', name: 'طاجن سكاي مود',          description: 'طاجن sky 7 الأسطوري — فخامة في كل لقمة',  price: 130, currency: 'ج.م', category: 'desserts', image: '/images/sweets/WhatsApp Image 2026-07-28 at 22.00.53 (2).jpeg', badge: 'New' },
  ...
  { id: 'fs-2',  name: 'فروت سلاط وسط',          description: 'سلطة فواكه وسط متنوعة وغنية',             price: 90,  currency: 'ج.م', category: 'fruit-salad', image: FRT[0], badge: 'Popular' },
  ...
  { id: 'fs-4',  name: 'سلطة فواكه سبيشال',      description: 'سلطة مميزة مع كريمة وعسل وبذور',          price: 150, currency: 'ج.م', category: 'fruit-salad', image: FRT[0], badge: "Chef's Choice" },
