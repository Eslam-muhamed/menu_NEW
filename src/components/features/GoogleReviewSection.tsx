...
interface Review {
  ...
  rating: number;
  text: string;
  avatar: string; // first letter(s) for avatar
}
...
function ReviewCard({ review, delay }: { review: Review; delay: number }) {
  ...
  return (
    ...
    >
      ...
      <div dir="rtl">
        <p style={{
          color: 'var(--text-2)', fontFamily: "'Cairo',sans-serif",
    ...
    >
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          onHoverStart={() => setCta(true)}
          onHoverEnd={() => setCta(false)}
          style={{
            ...
            boxShadow: cta
              ? '0 8px 32px rgba(201,153,61,0.45), 0 0 0 4px rgba(201,153,61,0.12)'
              : '0 6px 24px rgba(201,153,61,0.28)',
